...
<head>
  ...
  <meta property="og:url" content="https://www.mycoachsport.com/es/" />
  ...
  <link rel="alternate" hreflang="fr" href="https://www.mycoachsport.com/fr/" />
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/3.7.0/animate.min.css">

  <title>My Coach Sport - Registro válido</title>
</head>
<body class="col full-H justify-between">
  <?php include('../menu.inc.php'); ?>

  <div class="col justify-center align-center w-75 m-auto">       
    <h2 class="txt-center">La suscriptión al boletín de My Coach Sport está validada.</h2>
    <a class="m-Top-60" href="../index.php"><div class=" col justify-center button-Connexion"><p class="section-Texte txt-center">Volver a la página de inicio</div></a>
    </div>
