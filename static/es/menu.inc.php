<nav class="navbar fixed-top navbar-dark navbar-expand-lg" id="nav">
  <a class="navbar-brand" href="/es/"><img src="/img/logo-mycoach-sport<?php echo ($page == 'homepage') ? '-white' :'';?>.svg" alt="My Coach Sport"></a>
          ...
          <div class="collapse navbar-collapse text-center justify-content-end" id="navbarNavDropdown">
            <ul class="navbar-nav">
              <li class="nav-item<?php echo ($page == 'apropos') ? ' active' :'';?>">
                <a class="nav-link" href="/es/quienes-somos/">Acerca de</a>
              </li>
              ...
              <li class="nav-item<?php echo ($page == 'presse') ? ' active' :'';?>">
                <a class="nav-link" href="/es/prensa/">Prensa</a>
              </li>
              ...
              <li class="nav-item dropdown language">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <span class="d-inline-block d-sm-none">Idioma:</span> ES
                </a>
